...
const NavBar = () => {
  ...
  return (
    <div className="bg-background h-[9rem] flex xl:relative justify-between max-lg:fixed top-0 right-0 left-0 w-full  items-center px-[8rem] relative  max-xl:px-[2rem] py-[1rem] max-lg:py-[0rem]  max-lg:h-[7rem]">
      <div>
        <Link href="/">
      ...
      <div className={`  flex z-50 justify-center items-center relative max-lg:absolute ${ isMobile ? "left-0 top-[7rem] bg-white z-40 w-full  py-6 flex-col  duration-500" : " max-lg:left-[-6000px] " }`}>
        <Link href="#" className="p-4 text-[20px] font-bold text-green">
          For Farmers
        </Link>
        <Link href="#" className="p-4 text-[20px] font-bold text-green">
          For Businesses
