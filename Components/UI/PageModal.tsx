      ...
      <div className="flex items-center justify-center min-h-screen">
        ...
        <div className="z-20 w-full max-w-2xl py-16 px-6 mx-auto bg-white shadow-lg">
          <div className="flex justify-center  flex-col items-center">
            <h2 className="text-3xl text-lightgreen font-bold">Choose Your Location</h2>
            <p className='text-center text-2xl font-medium'>Please choose your location to ensure accurate product availability and pricing</p>
          </div>
          <div className="mt-10">
          ...
          >
            <option value="option1"><MdOutlineShareLocation/>Location</option>
            ...
            <option value="option3">Ibadan</option>
              ...
              <button className='bg-lightgreen mt-3 w-full text-xl font-bold text-white text-center p-3' onClick={handleSubmit}>Submit</button>
            </form>
          </div>
        </div>
