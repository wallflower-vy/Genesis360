  ...
  return (
    <div className='bg-background flex px-[8rem] py-[8rem] gap-10 justify-between'>
        <div className='w-[59%]'>
            ...
            <div className='bg-lightgreen text-white mt-5 py-2 px-5 items-center flex justify-between'>
                <p className='font-bold text-2xl w-[90%]'>Experience the amazing world of farming with us.</p>
                <div className='bg-white h-[3rem]  rounded-lg  cursor-pointer w-[10%] flex justify-center'>
