  ...
  return (
    <div className=" bg-background">
      ...
      <div className=" bg-background h-[9rem] z-50  flex xl:relative justify-between max-lg:fixed top-0 right-0 left-0 w-full  items-center px-[8rem] relative  max-xl:px-[2rem] py-[1rem] max-lg:py-[0rem]  max-lg:h-[7rem]">
        ...
        <p className=" font-bold text-green text-[20px] leading-[25px] mr-[30px]">Don’t  have account yet?</p>
          
        <Link href="/">
          <button className="text-[#fff] py-2 px-16 font-bold text-center bg-lightgreen text-[20px]">Sign Up</button>
        </Link>
